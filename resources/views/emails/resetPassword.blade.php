...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Vous avez demandé la réinitialisation de votre mot de passe sur RiadBookingNow. Pour procéder au changement de votre mot de passe, veuillez cliquer sur le bouton ci-dessous :</p>

            <div style="text-align: center;">
                <a href="{{ $activationUrl }}" class="activation-btn">Réinitialiser mon mot de passe</a>
            </div>

            <div class="highlight-box">
                <p>Note importante : Ce lien de réinitialisation est valable pendant <strong>1 heure</strong>. Si le bouton ne fonctionne pas, veuillez copier et coller l'URL suivante dans votre navigateur :</p>
                <p style="word-break: break-all; font-size: 13px; color: #7a6a5a;">{{ $activationUrl }}</p>
            </div>

            <p>Pour votre sécurité, si vous n'avez pas initié cette demande de réinitialisation de mot de passe, veuillez ignorer cet email et sécuriser votre compte.</p>

            <p>Notre équipe reste à votre disposition pour toute assistance supplémentaire.</p>
